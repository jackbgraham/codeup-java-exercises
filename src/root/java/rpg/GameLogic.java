...
//
//    //battle method
//    public static void battle(Enemy enemy, int xp){
//        //main battle loop
//        while(true){
//            clearConsole();
...
//                //battle round recap
//                clearConsole();
//                printHeading("You dealt " + dmg + " damage to the " + enemy.name + ".");
//                printSeparator(15);
//                printHeading("The " + enemy.name + " dealt " + dmgTaken + " damage to you.");
...
//                    //increase player xp
//                    player.xp += enemy.xp;
//                    System.out.println("You have gained " + enemy.xp + " XP.");
//                    anythingToContinue();
//                    break;
//                }
//            }else if(input == 2){
...
//                //run away
//                clearConsole();
//                //check if player is in boss fight, no escaping
//                if(act != 4){
//                    //35% chance to escape
//                    if(Math.random()*10 + 1 <= 3.5){
//                        printHeading("You have escaped combat.");
//                        anythingToContinue();
//                        break;
//                    }else{
//                        printHeading("Your attempt to flee has failed.");
...
//                    }
//                }else{
//                    printHeading("There is no escape from your destiny.");
//                    anythingToContinue();
//                }
//            }
//        }
...
//    }
//
//    //method that is called when player dies
//    public static void playerDied(){
//        clearConsole();
//        printHeading("Your journey ends here, you return to the void from whence you came...");
//    }
//
//    //the main loop
